...
def checkpoint_generation( df , name = '1_generation_01.json' ):
...
# %%
df_generated_input = pd.read_json( params['output_results'] + '1_generation_01.json' )
